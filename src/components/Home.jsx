  ...
  return (
    <div className="home-container">
      ...
      <p className="home-description">
        In this application, you can check the weather in several convenient ways:
      ...
      <section>
        ...
        <p>
          This application was developed by Arina Naletko, a beginner frontend developer. You can contact me on Telegram: <a href="https://t.me/she_is_arina" target="_blank" rel="noopener noreferrer">she_is_arina</a>.
        </p>
      </section>
      <section>
        <h2>Other Resources:</h2>
        <ul>
          <li><a href="https://github.com/stealdeff" target="_blank" rel="noopener noreferrer">GitHub</a></li>
          <li><a href="mailto:Ukam.naletko@mail.ru" target="_blank" rel="noopener noreferrer">Ukam.naletko@mail.ru</a></li>
        </ul>
      </section>
      <footer>
